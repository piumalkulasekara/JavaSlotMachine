...
public class StackWindow extends JFrame {
    ...
    public StackWindow(int noOfWins, int noOfLose, int noOfSpin) {
        ...
        /*create new JProgressBar for to visualize informations in the window(to display credit average)
        This graphical component(JProgressBar) is easy way to findout informations of the users*/
